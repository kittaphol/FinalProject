...
if(!empty($_GET['search'])){
    ...
    $sqlShowBooking =  "select booking.BookingID, booking.Bookingdate, booking.Payment, booking.TotalPrice, booking.Destination, 
                            ...
                            from booking, timetable where booking.TimetableID=timetable.TimetableID and timetable.Date LIKE '%" . $search ."%' and booking.BookingStatus='3';";
}else{
    $sqlShowBooking = "select booking.BookingID, booking.Bookingdate, booking.Payment, booking.TotalPrice, booking.Destination, 
                               booking.BookingStatus, booking.TimetableID, booking.SeatID, booking.CustomerID, booking.Username,
                               timetable.Date, timetable.Time
                               from booking, timetable where booking.TimetableID=timetable.TimetableID and booking.BookingStatus='3';";
}
...
<head>
  ...
  <script>
    function confvar(rec, rec2) {
      ...
      if (ans == true) {
        window.open('Main_ConfirmPayment.php?BookingID=' + rec + '&Payment=' + rec2 + '&SumConfirm=1', '_self');
      } else
    ...
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h2>สรุปรายการซื้อที่นั่ง</h2>
          <div class="btn-toolbar mb-2 mb-md-0">
            <!--<div class="btn-group mr-2"><a class="btn btn-outline-success" href="Main_ConfirmSeatAdd.php" role="button">เพิ่ม</a></div>-->
          </div>
        </div>
        <h5 align="center">ตรวจสอบสรุปรายการซื้อที่นั่ง</h5><br>
        <form  class="form-inline" action= 'Main_SumConfirm.php' method='get'>
        ...
        <div class="table-style">
          <table class="table table-striped shadow-lg p-3 mb-5 bg-white rounded">
            ...
            while ($recnumShowBooking = mysqli_fetch_array($resultShowBooking)) {
              ...
              if ($recnumShowBooking['BookingStatus'] == '3') {
              ...
              if ($recnumShowBooking['BookingID'] == $chkBookingID) {
               ...
               <td>$chkTotalPrice</td>
               <td>$BookingStatus</td>
               <td align='center'><a href='Main_CustomerCon.php?CustomerID=$chkCustomerID&SumConfirm=1'>ดูข้อมูลลูกค้า</a></td>"; ?>
              ...
              if ($checkroundall == $lashrow) {
               ...
               <td>$BookingStatus</td>
               <td align='center'><a href='Main_CustomerCan.php?CustomerID=$recnumShowBooking[CustomerID]&SumConfirm=1'>ดูข้อมูลลูกค้า</a></td>"; ?>
