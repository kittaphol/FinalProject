...
<head>
    ...
    <title>Main_CancelPayment</title>
    <style>
        .style-sidebar {
            background: #F0FFF0;
            padding: 5px;
          ...
          <ul class="nav flex-column mb-2">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <?php
                    if (isset($_REQUEST['SumCancel'])) {
                    ?><h2>สรุปรายการยกเลิกที่นั่ง</h2><?php
                                                } else {
                                                    ?><h2>ยืนยันรายการยกเลิกที่นั่ง</h2><?php
                                                                                        } ?>
                    <div class="btn-toolbar mb-2 mb-md-0">
                        ...
                        if (isset($_REQUEST['SumCancel'])) {
                        ?><div class="btn-group mr-2"><a class="btn btn-outline-danger" href="Main_SumCancel.php" role="button">ย้อนกลับ</a></div><?php
                                                                                                                                                } else {
                                                                                                                                                    ?><div class="btn-group mr-2"><a class="btn btn-outline-danger" href="Main_CancelShowSeat.php?BookingID=<?php echo $BookingID; ?>" role="button">ย้อนกลับ</a></div><?php
                                                                                                                                                } ?>
                    </div>
                </div>

                <h5 align="center">ตรวจสอบการชำระเงินการซื้อที่นั่ง</h5><br>
                <div class="table-style">
                   ...
                   from booking, timetable where booking.TimetableID=timetable.TimetableID and booking.BookingID='$BookingID'";
                        ...
                        while ($recnumShowBooking = mysqli_fetch_array($resultShowBooking)) {
                            ...
                            if ($checkround == 1) {
                                ...
                                <td align='center'>
                                    <b>รหัสรายการที่นั่ง : $recnumShowBooking[BookingID]</b><br><br>

                                    <img src='images_user/" . $recnumShowBooking['Payment'] . "'>
                                </td></tr><tbody>";
                                                                                }
