...
<head>
  ...
  <title>Main_Location</title>
  <script>
    function confdel(rec) {
      var ans;
      ans = confirm('ท่านต้องการลบรายการนี้หรือไม่ ?');
      if (ans == true) {
        //alert('ลบรายการนี้');
        window.open('delLocation.php?LocationID=' + rec, '_self');
      } else
    ...
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h2>สถานที่ปลายทาง</h2>
          <div class="btn-toolbar mb-2 mb-md-0">
            <!--<div class="btn-group mr-2"><a class="btn btn-outline-success" href="Main_BusAdd.php" role="button">เพิ่ม</a></div>-->
            <form class="form-inline" name='AddLocation' action="saveAddLocation.php" method="post">
              <div class="form-group">
                <label>สถานที่ปลายทาง :</label>
                <input type="text" class="form-control mx-sm-2" name="LocationName" placeholder="">
        ...
        <h5 align="center">รายละเอียดสถานที่ปลายทาง</h5><br>
        ...
        <div class="table-style">
          <table class="table table-striped shadow-lg p-3 mb-5 bg-white rounded">
            ...
            $sqlShowLocation = "select * from location;";
            $resultShowLocation = mysqli_query($connect, $sqlShowLocation);


            if ($resultShowLocation == null) {
              echo "คำสั่งผิด";
            }

            while ($recnumShowLocation = mysqli_fetch_array($resultShowLocation)) {
              echo "<tbody>"; ?><tr class="bg-light text-center small"><?php echo "
                        <td align='center'>$recnumShowLocation[LocationName]</td>
                        <td align='center'>$recnumShowLocation[Username]</td>"; ?>
                <td align='center'><button onclick="confdel('<?php echo $recnumShowLocation['LocationID']; ?>')">ลบ</button></td>
              <?php "</tr></tbody>";
            }
              ?>
          </table>
