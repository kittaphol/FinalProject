...
<head>
    ...
    <title>Main_Customer</title>
    <script>
        function confedit(rec) {
            var ans;
            ans = confirm('ท่านต้องการแก้ไขรายการนี้ = ' + rec);
            if (ans == true) {
                window.open('editCustomer.php?TimetableID=<?php echo $TimetableID?>&CustomerID=' + rec, '_self');
            } else
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <div class="btn-group mr-2"><a class="btn btn-outline-danger" 
                        href="Main_CheckSeat4.php?TimetableID=<?php echo $TimetableID?>" role="button">ย้อนกลับ</a></div>
                ...
                <div class="table-style">
                    ...
                    while ($recnumShowCustomer = mysqli_fetch_array($resultShowCustomer)) {
                        ...
                        <td align='center'><button onclick="confedit('<?php echo $recnumShowCustomer['CustomerID']; ?>')">แก้ไข</button></td>
                    <?php "</tr><tbody>";
                    }
                    ?>
                </table>
