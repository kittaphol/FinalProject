            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <div class="btn-group mr-2"><a class="btn btn-outline-danger" href="Main_CheckSeat.php" role="button">ย้อนกลับ</a></div>
                    </div>
                </div>
                ...
                <form name="SelectSeat" action="Main_AddUser.php" method='POST'>

                    <div class="form-group Button">
                        <br>
                        <a class="btn btn-primary" href="Main_CheckSeat4.php?TimetableID=<?php echo $TimetableID ?>" role="button">
                            ดูข้อมูลที่นั่ง</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <button type="submit" class="btn btn-primary">เพิ่มที่นั่ง</button>
