...
<head>
  ...
  <title>Main_CancelShowSeat</title>
  <script>
    function confvar(rec, rec2) {
      var ans;
      ans = confirm('ท่านต้องการตรวจสอบรายการนี้ = ' + rec);
      if (ans == true) {
        window.open('Main_CancelPayment.php?BookingID=' + rec + '&Payment=' + rec2, '_self');
      } else
    ...
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          ...
          <div class="btn-group mr-2"><a class="btn btn-outline-danger" href="Main_CancelSeat.php" role="button">ย้อนกลับ</a></div>
          </div>
        </div>
