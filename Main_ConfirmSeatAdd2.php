...
<head>
  ...
  <title>Main_ConfirmSeatAdd2</title>
  <style>
    .style-sidebar {
      background: #F0FFF0;
      padding: 5px;
...
<body>
  <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
    ...
    <a class="btn btn-outline-primary" href="Checklogout.php.php">Sign out</a>
  </div>
  <div class="container-fluid">
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <h5>เพิ่มรายการที่นั่ง</h5>

        <form name='BusAdd' action="saveAddBus.php" method="post">
          ...
          <div class="form-group">
            <a class="btn btn-primary" href="Main_ConfirmSeat.php" role="button">Back</a>&nbsp;&nbsp;&nbsp;&nbsp;
