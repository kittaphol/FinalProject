  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <h5 align="center">เพิ่มตารางเที่ยวรถ</h5><br>

        <form name='BusAdd' action="saveAddTimetable.php" method="post">
          ...
          <div class="form-group button">
            <a class="btn btn-primary" href="Main_Timetable.php" role="button">Back</a>&nbsp;&nbsp;&nbsp;&nbsp;
...
<!--วินต้า
        <select name='catCode'>
            ...
            /*
							...
							{
								echo "<option value='$recnumSearchCat[0]'>$recnumSearchCat[1]</option>";
							}
*/
            ?>
					</select> -->