...
<head>
  ...
  <script>
    ...
    function confdel(rec) {
      ...
      if (ans == true) {
        //alert('ลบรายการนี้');
        window.open('delBus.php?BusID=' + rec, '_self');
      } else
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <h5 align="center">รายละเอียดรถทัวร์</h5><br>
        <div class="table-style">
          ...
          $sqlShowBus = "select * from bus;";
          $resultShowBus = mysqli_query($connect, $sqlShowBus);


          if ($resultShowBus == null) {
            echo "คำสั่งผิด";
          }

          while ($recnumShowBus = mysqli_fetch_array($resultShowBus)) {
            echo "<tbody>"; ?><tr class="bg-light text-center small"><?php echo "
                        <td>$recnumShowBus[BusID]</td>
                        <td>$recnumShowBus[Color]</td>
                        <td>$recnumShowBus[Model]</td>
                        <td align='center'>$recnumShowBus[Numseat]</td>
                        <td align='center'>$recnumShowBus[Username]</td>
                        <td align='center'><a href='Main_BusSeat.php?BusID=$recnumShowBus[BusID]'>จัดการที่นั่ง</a></td>"; ?>
            <td align='center'><button onclick="confedit('<?php echo $recnumShowBus['BusID']; ?>')">แก้ไข</button></td>
            <td align='center'><button onclick="confdel('<?php echo $recnumShowBus['BusID']; ?>')">ลบ</button></td>
          <?php "</tr></tbody>";
          }
          ?>
        </table>
