        ...
        function confselect(rec)
          {
            ...
            if(ans == true){
              window.open('Main_BustableShow.php?TimetableID=' + rec ,'_self');
            }
            else
        ...
        <?php
            ...
            while($recnumShowBustable = mysqli_fetch_array($resultShowBustable))
            {
              echo "<tbody>"; ?><tr class="bg-light text-center small"><?php echo "
                        ...
                        <td align='center'><button onclick="confselect('<?php echo $recnumShowBustable['TimetableID']; ?>')">แสดงที่นั่ง</button></td>
                <?php  "</tr></tbody>";  
            }
            ?>
