...
<head>
    ...
    <title>Main_ConfirmPayment</title>
    <style>
        .style-sidebar {
            background: #F0FFF0;
            padding: 5px;
          ...
          <ul class="nav flex-column mb-2">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <?php
                    if (isset($_REQUEST['SumConfirm'])) {
                    ?><h2>สรุปรายการซื้อที่นั่ง</h2><?php
                                                } else {
                                                    ?><h2>ยืนยันรายการซื้อที่นั่ง</h2><?php
                                                                                        } ?>
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <?php
                        if (isset($_REQUEST['SumConfirm'])) {
                        ?><div class="btn-group mr-2"><a class="btn btn-outline-danger" href="Main_SumConfirm.php" role="button">ย้อนกลับ</a></div><?php
                                                                                                                                                } else {
                                                                                                                                                    ?><div class="btn-group mr-2"><a class="btn btn-outline-danger" href="Main_ConfirmSeat.php" role="button">ย้อนกลับ</a></div><?php
                                                                                                                                                } ?>
                    </div>
                </div>
